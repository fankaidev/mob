/**
 * Backend copy of Anthropic provider.
 * Copied from frontend/src/lib/pi-ai/src/providers/anthropic.ts
 * Simplified for server-side: no dangerouslyAllowBrowser, no OAuth stealth mode.
 */
...
export function calculateCost<TApi extends Api>(model: Model<TApi>, usage: AssistantMessage["usage"]): void {
