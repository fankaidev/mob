...
export function createInitialState(
	totalLines: number,
	filename?: string,
	rangeStates?: Map<string, import("./types").RangeState>,
): SedState {
	return {
		patternSpace: "",
		holdSpace: "",
...
function isRelativeOffset(address: SedAddress): address is import("./types").RelativeOffset {
...
function globalReplace(
	input: string,
	regex: import("../../regex/index").UserRegex,
	_replacement: string,
