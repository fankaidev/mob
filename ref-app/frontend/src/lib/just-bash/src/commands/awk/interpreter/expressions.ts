...
import type { AwkArrayAccess, AwkExpr, AwkFieldRef, AwkFunctionDef, AwkVariable } from "../ast";
...
import { isTruthy, looksLikeNumber, matchRegex, toAwkString, toNumber } from "./type-coercion";
import type { AwkValue } from "./types";
import { getArrayElement, getVariable, hasArrayElement, setArrayElement, setVariable } from "./variables";

// Forward declaration for statement executor (needed for user functions)
export type BlockExecutor = (ctx: AwkRuntimeContext, statements: import("../ast").AwkStmt[]) => Promise<void>;
