...
import { type AwkFileSystem, AwkInterpreter, createRuntimeContext } from "./interpreter/index";
...
export const awkCommand2: Command = {
	...
	async execute(args: string[], ctx: CommandContext): Promise<ExecResult> {
		...
		let fieldSep: import("../../regex/index").RegexLike = new ConstantRegex(/\s+/);
		let fieldSepStr = " ";
...
function createFieldSepRegex(sep: string): import("../../regex/index").UserRegex {
	if (sep === " ") {
