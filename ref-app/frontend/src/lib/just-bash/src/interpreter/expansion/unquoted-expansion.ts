...
import type { ArithExpr, ParameterExpansionPart, SubstringOp, WordNode, WordPart } from "../../ast/types";
import { createUserRegex } from "../../regex/index";
import { GlobExpander } from "../../shell/glob";
import { GlobError } from "../errors";
import { getIfs, getIfsSeparator, isIfsEmpty, isIfsWhitespaceOnly, splitByIfsForExpansion } from "../helpers/ifs";
