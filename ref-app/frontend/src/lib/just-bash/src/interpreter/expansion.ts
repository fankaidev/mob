...
import { expandDollarVarsInArithText, expandSubscriptForAssocArray } from "./expansion/arith-text-expansion";
import { expandBraceRange } from "./expansion/brace-range";
import { getFileReadShorthand } from "./expansion/command-substitution";
// Import from extracted modules
import { escapeGlobChars, escapeRegexChars, hasGlobPattern } from "./expansion/glob-escape";
import {
	computeIsEmpty,
	handleArrayKeys,
	handleAssignDefault,
...
import { expandWordWithGlobImpl, type WordGlobExpansionDeps } from "./expansion/word-glob-expansion";
import { smartWordSplit } from "./expansion/word-split";
import { buildIfsCharClassPattern, getIfs, isIfsEmpty, splitByIfsForExpansion } from "./helpers/ifs";
