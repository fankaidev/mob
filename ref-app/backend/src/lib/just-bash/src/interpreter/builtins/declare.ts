...
import { checkReadonlyError, markExported, markReadonly, unmarkExported } from "../helpers/readonly";
...
import { parseArrayElements, parseAssocArrayLiteral } from "./declare-array-parsing";
import {
	listAllVariables,
...
import { markLocalVarDepth, parseAssignment, setVariable } from "./variable-assignment";
