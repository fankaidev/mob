...
import type { CommandRegistry, ExecResult, FeatureCoverageWriter, TraceCallback } from "../types";
...
import { type BuiltinDispatchContext, dispatchBuiltin, executeExternalCommand } from "./builtin-dispatch";
import { findCommandInPath as findCommandInPathHelper } from "./command-resolution";
import { evaluateConditional } from "./conditionals";
import { executeCase, executeCStyleFor, executeFor, executeIf, executeUntil, executeWhile } from "./control-flow";
import {
	ArithmeticError,
...
import { failure, OK, result, testResult, throwExecutionLimit } from "./helpers/result";
...
import { applyRedirections, preOpenOutputRedirects, processFdVariableRedirections } from "./redirections";
