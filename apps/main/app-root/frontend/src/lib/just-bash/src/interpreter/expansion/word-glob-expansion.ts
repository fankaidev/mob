...
import type { ArithExpr, ParameterExpansionPart, WordNode, WordPart } from "../../ast/types";
import { GlobExpander } from "../../shell/glob";
import { GlobError } from "../errors";
import { getIfs, getIfsSeparator, isIfsEmpty, splitByIfsForExpansion } from "../helpers/ifs";
import type { InterpreterContext } from "../types";
import { analyzeWordParts } from "./analysis";
import { handleArrayPatternRemoval, handleArrayPatternReplacement } from "./array-pattern-ops";
import {
	handleArrayDefaultValue,
	handleArrayPatternWithPrefixSuffix,
	handleArrayWithPrefixSuffix,
} from "./array-prefix-suffix";
import { handleArraySlicing, handleArrayTransform } from "./array-slice-transform";
import { handleNamerefArrayExpansion, handleSimpleArrayExpansion } from "./array-word-expansion";
